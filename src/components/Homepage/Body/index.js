      ...
      <div id="services_section" data-aos="fade-up">
        ...
        <div className="services_container">
          <div className="service_item" data-aos="zoom-in" data-aos-delay="300">
            ...
            />
            <h3 className="service_title">Alquiler de Caballos</h3>
            <p className="service_description">
              Ofrecemos caballos bien entrenados para alquiler por horas o días.
              Disfruta de un paseo inolvidable en la naturaleza.
            </p>
          </div>
          <div className="service_item" data-aos="zoom-in" data-aos-delay="400">
            <FontAwesomeIcon
              ...
              className="service_icon"
            />
            <h3 className="service_title">Alquiler de Establos</h3>
            <p className="service_description">
              Contamos con establos amplios y seguros para que puedas dejar a tu
              caballo con nosotros. Mantenemos las mejores condiciones.
            </p>
          </div>
        ...
        <div className="testimonials_container">
          ...
          >
            <p className="testimonial_text">
              ...
              volveremos pronto." - Ana Martínez
            </p>
            <img
              src={Testimonial2}
              alt="Ana
